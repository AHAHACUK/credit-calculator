                  ...
                  children: [
                    ...
                    Observer(builder: (_) {
                      return Switcher(
                        ...
                        enabledColor: CoreColors
                            .creditCalculationMethodSwitcherBackground,
                        disabledColor: CoreColors
                            .creditCalculationMethodSwitcherBackground,
                        handleColor:
                ...
                Observer(builder: (context) {
                  return CreditCalculationPageField(
                    ...
                    error: validationErrorMapper
                        .call(pageController.creditSumError),
                  );
                }),
                Observer(builder: (_) {
                  return CreditCalculationPageField(
                    header: AppLocalizations.of(context).creditTimeInMonths,
                    ...
                    child: CoreButtonPresets.button(
                      ...
                      onTap: () async {
                        final creditCalculation =
                            await showCreditCalculationChooseBottomSheet(
                                context);
